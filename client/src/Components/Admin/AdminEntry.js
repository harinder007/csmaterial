...
function AdminEntry({ data }) {
  ...
  if (data.material.toLowerCase() === 'previous year') {
    ...
    url = `${process.env.NEXT_PUBLIC_URL}/api/papers`;
    isYear = true;
    ...
    url = `${process.env.NEXT_PUBLIC_URL}/api/syllabuses`;
    isSubject = true;
    ...
    url = `${process.env.NEXT_PUBLIC_URL}/api/studyMaterial`;
    isSubject = true;
    isTopic = true;
    ...
    url = `${process.env.NEXT_PUBLIC_URL}/api/programs`;
    isTopic = true;
  }
